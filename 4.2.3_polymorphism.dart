...
main(){
  ...
  ///Polymorphism:(many forms)Different behaviour ,same entity
  ///here student are both person and businessmen as a polymorphism;

  Student Abu=Person('name', 25);
  Student Bakar=Businessmen('URI');
